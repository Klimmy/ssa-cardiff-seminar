...
\medskip
    \includegraphics[height = 2cm, width = 4.5cm]{images/cp_mean_2}\qquad
    \includegraphics[height = 2cm, width = 4.5cm]{images/005_point}
...
\medskip
  \begin{columns}[T,onlytextwidth]
	...
	\includegraphics[scale=0.16]{images/long_ts_1}
      \column{0.5\textwidth}
	\includegraphics[scale=0.16]{images/long_ts_3}
     \end{columns}
\end{frame}
